...
public class RecipeManager implements Listener {
    ...
    public void registerRecipes() {
        ...
        axeMirroredRecipe.setIngredient('c', cupriteChoice);
        axeMirroredRecipe.setIngredient('s', Material.STICK);
        registerOrReplace(axeMirroredRecipe);

        // 6. Désactivation du craft vanilla du coffre piégé (trapped_chest) et définition du Coffre en Cuprite
        try {
        ...
        chestRecipe.setIngredient('c', cupriteChoice);
        chestRecipe.setIngredient('C', Material.CHEST);
        registerOrReplace(chestRecipe);

        // 7. Amélioration Marteau Palier II (Table de Forge : Marteau T1 + Bloc de Cuprite)
        org.bukkit.inventory.SmithingTransformRecipe hammerTier2Recipe = new org.bukkit.inventory.SmithingTransformRecipe(
                ...
                new RecipeChoice.MaterialChoice(CupriteBlock.BASE_MATERIAL),
                false
        );
